...
### Defining the paraments
life_epectancy <- 50
mu <- (1 / life_epectancy) / 365.25 # daily death rate
p <- 0
N0 <- 500000
v <- mu * p
...
points(E.star(beta.calc(118),N0)/N0,S.star(beta.calc(18),N0)/N0,pch="*",col="red")
